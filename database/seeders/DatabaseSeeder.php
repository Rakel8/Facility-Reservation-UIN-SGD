...
class DatabaseSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        $rooms = [
            ...
            [
                'nama_ruangan' => 'Ruang Seminar Gedung A',
                'kapasitas' => 100,
                'fasilitas' => 'Whiteboard, Proyektor, WiFi',
                'status_aktif' => true,
            ],
            [
                'nama_ruangan' => 'Laboratorium Komputer Lantai 2',
                'kapasitas' => 40,
                'fasilitas' => 'Komputer, Printer, Jaringan LAN',
                'status_aktif' => true,
            ],
            [
                'nama_ruangan' => 'Ruang Rapat Direktur',
                'kapasitas' => 20,
                'fasilitas' => 'Meja Konferensi, Proyektor, AC',
                'status_aktif' => true,
            ],
            [
                'nama_ruangan' => 'Perpustakaan Gedung B Lantai 3',
                'kapasitas' => 60,
                'fasilitas' => 'Rak Buku, Meja Belajar, AC, WiFi',
                'status_aktif' => true,
            ],
        ];
